...
function Speedometer:__init()
    ...
    self.unit = 1 -- 0: м/с 1: км/ч 2: миль
...
function Speedometer:CreateSettings()
    ...
    self.window:SetTitle( "Настройки спидометра" )
    ...
    bottom_checkbox:GetLabel():SetText( "Экранный спидометр" )
    ...
    center_checkbox:GetLabel():SetText( "Режим для 1-го лица" )
    ...
    Events:Fire( "HelpAddItem",
        {
            name = "Спидометр",
            text = 
                "Спидометр - это хедз-ап, показывающий " ..
                "текущую скорость в м/с, км/ч или миль.\n\n" ..
                "Чтобы настроить его, введите /speedometer или /speedo в чате."
        } )
end
