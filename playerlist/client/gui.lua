...
function ListGUI:__init()
	...
	self.window:SetTitle( "Всего Игроков: 0" )
	...
	self.filterGlobal:GetLabel():SetText( "Поиск по полному имени" )
	...
	self.window:SetTitle("Всего Игроков: "..tostring(self.PlayerCount))
    ...
    Events:Fire( "HelpAddItem",
        {
            name = "Список Игроков",
            text = 
                "Список игроков - это основной список игроков и их пинг. " ..
                "Доступ к нему возможен нажатием F6."
        } )
end
